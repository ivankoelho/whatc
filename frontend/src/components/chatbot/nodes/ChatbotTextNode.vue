...
const message = computed(() => {
  ...
  return msg.length > 60 ? msg.slice(0, 60) + '...' : msg || t('chatbot.nodes.noMessage')
})
...
<template>
  <BaseNode :label="data?.label || t('chatbot.nodes.text')" header-class="bg-blue-600" :has-input="!data?.isEntryNode">
