...
func TestApp_UpdateAccount_DefaultTeam_InvalidUUID(t *testing.T) {
	t.Parallel()
...
func TestApp_UpdateAccount_DefaultTeam_ClearsWithEmptyString(t *testing.T) {
	t.Parallel()
